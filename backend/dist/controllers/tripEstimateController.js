...
exports.getTripEstimateHandler = getTripEstimateHandler;
exports.getBatchTripEstimates = getBatchTripEstimates;
const costEstimationService_1 = require("../services/costEstimationService");
 ...
 */
function getTripEstimateHandler(req, res) {
    try {
        const body = req.body;
        ...
        // Get trip estimate
        const estimate = (0, costEstimationService_1.getTripEstimate)(destination, body.origin, body.travelers, body.departureDate, body.returnDate);
 ...
 */
function getBatchTripEstimates(req, res) {
    try {
        const { origin, destinationIds, travelers, departureDate, returnDate, } = req.body;
        // Validate required fields
        ...
        for (const destId of destinationIds) {
            ...
            const estimate = (0, costEstimationService_1.getTripEstimate)(destination, origin, travelers, departureDate, returnDate);
